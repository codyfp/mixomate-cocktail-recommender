...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="bg-[url('/images/index-background.jpg')] bg-no-repeat bg-cover bg-[left_-80px] text-white py-28 px-16 flex h-full w-full">
        <div className="flex flex-1 flex-col justify-between h-full w-full">
          <h1 className="x-title !text-7xl">MIXOMATE</h1>

          <button className="x-title bg-red-900 w-max py-5 px-12 rounded-3xl hover:bg-red-950">
            Get Started!
          </button>
        </div>
